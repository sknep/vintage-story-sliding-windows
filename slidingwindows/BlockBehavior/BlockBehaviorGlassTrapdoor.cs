...
{
    /// <summary>
    /// Marks a block as an animated trapdoor. Requires the use of the <see cref="BEBehaviorGlassTrapdoor"/> block entity behavior.
    ...
    public class BlockBehaviorGlassTrapdoor : StrongBlockBehavior, IClaimTraverseable
    {
        /// <summary>
        ...
        public BlockBehaviorGlassTrapdoor(Block block) : base(block)
        {
        ...
        {
            var beh = world.BlockAccessor.GetBlockEntity(blockSel.Position)?.GetBehavior<BEBehaviorGlassTrapdoor>();
        ...
        public override void OnDecalTesselation(IWorldAccessor world, MeshData decalMesh, BlockPos pos, ref EnumHandling handled)
        {
            ...
            var beh = world.BlockAccessor.GetBlockEntity(pos)?.GetBehavior<BEBehaviorGlassTrapdoor>();
            if (beh != null)
            {
        ...
        public bool placeDoor(IWorldAccessor world, IPlayer byPlayer, ItemStack itemstack, BlockSelection blockSel, BlockPos pos, IBlockAccessor ba)
        {
            ...
            var bh = ba.GetBlockEntity(pos)?.GetBehavior<BEBehaviorGlassTrapdoor>();
        ...
        public override Cuboidf[] GetCollisionBoxes(IBlockAccessor blockAccessor, BlockPos pos, ref EnumHandling handled)
        {
            ...
            return blockAccessor.GetBlockEntity(pos)?.GetBehavior<BEBehaviorGlassTrapdoor>()?.ColSelBoxes ?? null;
        }
        ...
        {
            handled = EnumHandling.PreventDefault;
            var beh = block.GetBEBehavior<BEBehaviorGlassTrapdoor>(pos);
